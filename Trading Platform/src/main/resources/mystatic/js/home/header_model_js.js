...
jQuery(document).ready(function ($) {
    ...
    //                 window.history.pushState('forward', null,'./?tradingandXYF=后退不了了吧，我故意设置的');
    //             }
    //         }
    //     });
    //     window.history.pushState('forward', '/?trading','./?tradingandXYF='+new Date().getTime());
    // }
    //监听关闭事件
