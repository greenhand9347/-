...
import com.trading.bean.GoodsCarBean;
import com.trading.bean.ShopInformationBean;
import com.trading.bean.UserWantBean;
import com.trading.config.FileConfig;
import com.trading.pojo.*;
import com.trading.response.BaseResponse;
import com.trading.service.*;
import com.trading.token.TokenProccessor;
import com.trading.tool.SaveSession;
import com.trading.tool.StringUtils;
...
/*import com.trading.tool.OCR;
import com.trading.tool.Pornographic;*/
...
//        //从session中获得用户的基本信息
        ...
        if (action == 1) {
            ...
            StringBuilder trading = new StringBuilder();
            trading.append(StringUtils.getInstance().getRandomChar()).append(System.currentTimeMillis()).append(".jpg");
            thumbnails.append(trading);
...
/*            String pornograp = Pornographic.CheckPornograp("D:\\" + random);
            ...
            if (StringUtils.getInstance().thumbnails(path + random, thumbnails.toString())) {
                save = "/toImage/thumbnails/" + trading;
            } else {
